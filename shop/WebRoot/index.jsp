			...
			<c:forEach items="${applicationScope.bigList}" var="list">
				...
				<ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
					...
					<c:forEach items="${list}" var="product">
					 <li>
						<a target="_blank" href="product_get.action?id=${product.id}" class="product_image"> <img src="${shop}/image/${product.pic}" width="220" height="242"/></a>
							<div class="product_info">
								<h3>
									<a href="product_get.action?id=${product.id}">商品名称:${product.name}</a>
								</h3>
