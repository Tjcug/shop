			...
			<div class="selection_container">
				<div class="pay-skip">
					...
					<div class="payskip-inner">
						<div>
							<span>订单号：</span><strong>${requestScope.p2_Order}</strong><span>请记住这个号码，以要在付款和查询中使用</span>
						</div>
						<div>
							<span>支付金额：</span><strong>${requestScope.p4_Amt}</strong>
						</div>
						<div>
							<span>支付方式：</span><img class="zffs" src="${shop}/images/yibao.jpg"/>
						</div>
						<div>
						  ...
						  <div>
							<form name="yeepay" action='https://www.yeepay.com/app-merchant-proxy/node' method='POST' target="_blank">
									...
									<div class="pay-sub">
										<input type='submit' value="登录网上银行立即支付"/>
									</div>
								</form>
						 </div>
					</div>
