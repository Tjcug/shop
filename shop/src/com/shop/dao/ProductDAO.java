...
public class ProductDAO extends BaseHibernateDAO {
	...
	public static final String XREMARK = "xremark";
	...
	public List findByExample(Product instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.shop.model.Product")
	...
	public List findByXremark(Object xremark) {
		return findByProperty(XREMARK, xremark);
	}
