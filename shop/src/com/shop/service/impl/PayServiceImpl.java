...
import com.shop.util.DigestUtil;
...
public class PayServiceImpl implements PayService {
	...
	// 完成数据的追加
		private String joinSendDataParam(SendData sendData) {
			...
			infoBuffer.append(formatString(sendData.getP0_Cmd()));
			infoBuffer.append(formatString(sendData.getP1_MerId()));
			infoBuffer.append(formatString(sendData.getP2_Order()));
			infoBuffer.append(formatString(sendData.getP3_Amt()));
			infoBuffer.append(formatString(sendData.getP4_Cur()));
			infoBuffer.append(formatString(sendData.getP5_Pid()));
			infoBuffer.append(formatString(sendData.getP6_Pcat()));
			infoBuffer.append(formatString(sendData.getP7_Pdesc()));
			infoBuffer.append(formatString(sendData.getP8_Url()));
			infoBuffer.append(formatString(sendData.getP9_SAF()));
			infoBuffer.append(formatString(sendData.getPa_MP()));
			infoBuffer.append(formatString(sendData.getPd_FrpId()));
			infoBuffer.append(formatString(sendData.getPr_NeedResponse()));
